 ...
 * @link https://github.com/fadrian06/log/
 * @package faslatam Log
 *
...
class Log extends AbstractLogger {
   ...
   */
  function __construct($fileName, $threshold = LogLevel::DEBUG) {
   ...
   * Example:
   * ```php
   * $format = '[{level}|{date}] {message}'; //[INF0|2013-04-25 13:37:42] This is an information message
   * ```
   * @param string $format
   * @return null
   */
